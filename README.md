...
* **Focus:** Core Sciences & Analytical Thinking.
...
* **Transition:** Bio-Science se Pre-Engineering mein switch kiya taake math aur physics ke zariye logic ko mazeed mazboot kar sakun.
...
* **The Launch:** Saylani Mass IT Training (SMIT) join kiya jahan Full-Stack Web Development (MERN) ki ragr-ragr se waqif hua.
* **Result:** Industry-level coding, real-time databases (MongoDB), aur advanced React patterns par grip hasil ki.
